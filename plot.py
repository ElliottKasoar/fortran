...
ax1.scatter(b[0, :, r_a_index], b[2, :, r_a_index], label=r'$\gamma_{\alpha, min}$', color='tab:blue', linewidth=1, marker='.')
ax1.scatter(b[0, :, r_a_index], b[3, :, r_a_index], label=r'$\gamma_{\alpha, max}$', color='tab:red', linewidth=1, marker='.')
ax1.legend()
...
R_a_index = int(num_values_b*0.9)
ax2.scatter(b[1, R_a_index, :], b[2, R_a_index, :], label=r'$\gamma_{\alpha, min}$', color='tab:blue', linewidth=1, marker='.')
ax2.scatter(b[1, R_a_index, :], b[3, R_a_index, :], label=r'$\gamma_{\alpha, max}$', color='tab:red', linewidth=1, marker='.')
