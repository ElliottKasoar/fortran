...
ax1.scatter(b[0, :], b[2, :], label=r'$\theta_{\alpha, min}$', color='tab:blue', linewidth=1, marker='.')
ax1.scatter(b[0, :], b[3, :], label=r'$\theta_{\alpha, max}$', color='tab:red', linewidth=1, marker='.')
ax1.legend()
...
R_a_index = int(num_values_b*0.9)
ax2.scatter(b[1, :], b[2, :], label=r'$\theta_{\alpha, min}$', color='tab:blue', linewidth=1, marker='.')
ax2.scatter(b[1, :], b[3, :], label=r'$\theta_{\alpha, max}$', color='tab:red', linewidth=1, marker='.')
